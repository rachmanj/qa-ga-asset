            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-projectAssets">
                            <thead>
                                <tr>
                                    <th width="10">
                            ...
                            <tbody>
                                @foreach($assets as $key => $asset)
                                    <tr data-entry-id="{{ $asset->id }}">
                                        ...
                                        <td>
                                            {{ $asset->project->bowheer ?? '' }}
                                        </td>
                                        <td>
                                            {{ $asset->department->alias ?? '' }}
                                        </td>
                                        <td>
...
@endcan
  ...
  let table = $('.datatable-projectAssets:not(.ajaxTable)').DataTable({ buttons: dtButtons })
