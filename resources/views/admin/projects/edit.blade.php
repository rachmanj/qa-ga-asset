                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.projects.update", [$project->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('code') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="code" id="code" value="{{ old('code', $project->code) }}" required>
                            @if($errors->has('code'))
                        ...
                        <div class="form-group {{ $errors->has('location') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="location" id="location" value="{{ old('location', $project->location) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('bowheer') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="bowheer" id="bowheer" value="{{ old('bowheer', $project->bowheer) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('is_active') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Project::IS_ACTIVE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="is_active_{{ $key }}" name="is_active" value="{{ $key }}" {{ old('is_active', $project->is_active) === (string) $key ? 'checked' : '' }} required>
